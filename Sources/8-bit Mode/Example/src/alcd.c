 ...
 *           - 8-bit parallel interface control for HD44780 compatible LCDs
...
/* -------------------------------------------------------
 * @brief Send data/command to LCD in 8-bit mode
...
void alcd_init(void)
{
    ...
    /* HD44780 initialization sequence for 8-bit mode */

 ...
 *           - GPIO pin mappings for 8-bit parallel interface
 *           - Display control functions
 *           - Custom character (CGRAM) support
 * 
 * @note     For detailed documentation with examples, visit:
 *           https://github.com/aKaReZa75/AVR_aLCD_GPIO
 ******************************************************************************
 */
#ifndef _alcd_H_
#define _alcd_H_
 ...
 * ------------------------------------------------------- */
#define __alcd_RS_Config   DDRB      /**< Register to configure the RS pin direction */
#define __alcd_RS_Control  PORTB     /**< Port register to control the RS pin */
 ...
 * ------------------------------------------------------- */
#define __alcd_EN_Config   DDRB      /**< Register to configure the EN pin direction */
#define __alcd_EN_Control  PORTB     /**< Port register to control the EN pin */
#define __alcd_EN_Pin      1         /**< Pin number for the EN pin */

/* -------------------------------------------------------
 * @brief LCD DB0 (Data Bit 0) pin configuration
 * ------------------------------------------------------- */
#define __alcd_DB0_Config  DDRD     /**< Register to configure the DB0 pin direction */
#define __alcd_DB0_Control PORTD    /**< Port register to control the DB0 pin */ 
#define __alcd_DB0_Pin     0        /**< Pin number for the DB0 pin */

/* -------------------------------------------------------
 * @brief LCD DB1 (Data Bit 1) pin configuration
 * ------------------------------------------------------- */
#define __alcd_DB1_Config  DDRD     /**< Register to configure the DB1 pin direction */
#define __alcd_DB1_Control PORTD    /**< Port register to control the DB1 pin */ 
#define __alcd_DB1_Pin     1        /**< Pin number for the DB1 pin */

/* -------------------------------------------------------
 * @brief LCD DB2 (Data Bit 2) pin configuration
 * ------------------------------------------------------- */       
#define __alcd_DB2_Config  DDRD      /**< Register to configure the DB2 pin direction */
#define __alcd_DB2_Control PORTD     /**< Port register to control the DB2 pin */
#define __alcd_DB2_Pin     2         /**< Pin number for the DB2 pin */    

/* -------------------------------------------------------
 * @brief LCD DB3 (Data Bit 3) pin configuration
 * ------------------------------------------------------- */
#define __alcd_DB3_Config  DDRD     /**< Register to configure the DB3 pin direction */
#define __alcd_DB3_Control PORTD    /**< Port register to control the DB3 pin */
#define __alcd_DB3_Pin     3        /**< Pin number for the DB3 pin */
...
#define __alcd_DB4_Pin     4         /**< Pin number for the DB4 pin */

/* -------------------------------------------------------
 * @brief LCD DB5 (Data Bit 5) pin configuration
 * ------------------------------------------------------- */
#define __alcd_DB5_Config  DDRD      /**< Register to configure the DB5 pin direction */
#define __alcd_DB5_Control PORTD     /**< Port register to control the DB5 pin */
#define __alcd_DB5_Pin     5         /**< Pin number for the DB5 pin */
 ...
 * ------------------------------------------------------- */
#define __alcd_DB7_Config  DDRD      /**< Register to configure the DB7 pin direction */
#define __alcd_DB7_Control PORTD     /**< Port register to control the DB7 pin */
#define __alcd_DB7_Pin     7         /**< Pin number for the DB7 pin */
 ...
 * ------------------------------------------------------- */
#ifdef __alcd_useBL
    #define __alcd_BL_Config   DDRB  /**< Register to configure the backlight pin direction */
    #define __alcd_BL_Control  PORTB /**< Port register to control the backlight pin */
    #define __alcd_BL_Pin      2     /**< Pin number for the backlight pin */
#endif
